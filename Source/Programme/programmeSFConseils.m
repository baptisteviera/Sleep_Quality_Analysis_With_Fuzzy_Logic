...
for i = 1:nb_ccl_conseils,
 ...
 %Recherche du conseils maximum !
 maxi=0;
 for i = 1:nb_ccl_conseils,
    if ccl_conseils(i)> maxi
        maxi=ccl_conseils(i);
    end;
 end;
        
 if maxi==ccl_conseils(15)
    disp('La qualité de votre sommeil est remarquable ! Votre train de vie est excellent ! Vous dormez comme un bébé ! Continuez ainsi !');
  end;

  if maxi==ccl_conseils(1)
    disp("La qualité de votre sommeil est médiocre ! Cependant vous n'êtes pas insomniaque, ni apnéique ! Veuillez consulter un médecin généraliste et si vous pouvez un neurologue afin que celui-ci vous aide à améliorer votre train de vie")
  end;

  if maxi==ccl_conseils(4);
     disp("La qualité de votre sommeil est médiocre ! Vous n'êtes pas insomniaque mais vous êtes un peu apnéique ! Veuillez consulter un médecin généraliste et si vous pouvez un neurologue afin que celui-ci vous aide à améliorer votre train de vie. Il est conseillé de voir un pneumologue pour limiter les apnées du sommeil")
  end;
  
  if maxi==ccl_conseils(5);
     disp("La qualité de votre sommeil est médiocre ! Vous n'êtes pas insomniaque mais vous êtes très apnéique ! Veuillez consulter un médecin généraliste et si vous pouvez un neurologue afin que celui-ci vous aide à améliorer votre train de vie. Il est très fortement conseillé de voir un pneumologue pour limiter les apnées du sommeil qui sont sévères !")
  end;
 
  if maxi==ccl_conseils(2);
     disp("La qualité de votre sommeil est médiocre ! Vous êtes un peu insomniaque mais vous n'êtes pas apnéique ! Veuillez consulter un médecin généraliste et si vous pouvez un neurologue afin que celui-ci vous aide à améliorer votre train de vie et trouver une solution pour limiter les insomnies")
  end;
 
  if maxi==ccl_conseils(6);
     disp("La qualité de votre sommeil est médiocre ! Vous êtes un peu insomniaque et vous êtes un peu apnéique ! Veuillez consulter un médecin généraliste et si vous pouvez un neurologue afin que celui-ci vous aide à améliorer votre train de vie et à limiter les insomnies. Il est conseillé de voir un pneumologue pour limiter les apnées du sommeil")
  end;
  
 if maxi==ccl_conseils(7);
     disp("La qualité de votre sommeil est médiocre ! Vous êtes un peu insomniaque mais vous êtes très apnéique ! Veuillez consulter un médecin généraliste et si vous pouvez un neurologue afin que celui-ci vous aide à améliorer votre train de vie et trouver une solution pour limiter les insomnies. Il est très fortement conseillé de voir un pneumologue pour limiter les apnées du sommeil qui sont sévères")
  end;
  
  if maxi==ccl_conseils(3);
     disp("La qualité de votre sommeil est médiocre ! Vous êtes très insomniaque mais vous n'êtes pas apnéique ! Veuillez consulter d'urgence un médecin généraliste et si vous pouvez un neurologue afin que celui-ci vous aide à améliorer votre train de vie et trouver une solution pour limiter les insomnies sévères.")
  end;
  
   if maxi==ccl_conseils(8);
     disp("La qualité de votre sommeil est médiocre ! Vous êtes très insomniaque mais vous êtes un peu apnéique ! Veuillez d'urgence consulter un médecin généraliste et si vous pouvez un neurologue afin que celui-ci vous aide à améliorer votre train de vie et trouver une solution pour limiter les insomnies sévères. Il est conseillé de voir un pneumologue pour limiter les apnées du sommeil")
  end;
  
  if maxi==ccl_conseils(9);
     disp("La qualité de votre sommeil est médiocre ! Vous êtes très insomniaque et vous êtes très apnéique ! Veuillez d'urgence consulter un médecin généraliste et si vous pouvez un neurologue afin que celui-ci vous aide à améliorer votre train de vie et trouver une solution pour limiter les insomnies sévères. Il est très fortement conseillé de voir un pneumologue pour limiter les apnées du sommeil qui sont sévères")
  end;
  
  if maxi==ccl_conseils(10);
     disp("La qualité de votre sommeil est normale sans être excellente ! Vous êtes ni insomniaque ni apnéique ! Il pourrait être utile de consulter un médecin généraliste voire un neurologue afin que celui-ci vous aide à améliorer votre train de vie")
  end;
  
  if maxi==ccl_conseils(11);
     disp("La qualité de votre sommeil est normale sans être excellente ! Vous êtes un peu insomniaque mais vous n'êtes pas apnéique ! Il serait tout de même intéressant de consulter un médecin généraliste et si vous pouvez un neurologue afin que celui-ci vous aide à améliorer votre train de vie et trouver une solution pour limiter vos petites insomnies")
  end;
  
  if maxi==ccl_conseils(17);
     disp("Les informations personnelles saisies sont incohérentes")
  end;
  
  if maxi==ccl_conseils(13);
     disp("La qualité de votre sommeil est normale sans être excellente ! Vous n'êtes pas insomniaque mais vous êtes un peu apnéique ! Il pourrait être utile de consulter un médecin généraliste voire un neurologue afin que celui-ci vous aide à améliorer votre train de vie. Il pourrait aussi être intéressant de consulter un pneumologue pour limiter les petites apnées du sommeil")
  end;
  
  if maxi==ccl_conseils(14);
     disp("La qualité de votre sommeil est normale mais elle est à la limite d'être faibe ! Vous êtes un peu insomniaque et un peu apnéique ! Veuillez consulter un médecin généraliste et si vous pouvez un neurologue afin que celui-ci vous aide à améliorer votre train de vie et trouver une solution pour limiter les petites insomnies. Il est aussi conseillé de voir un pneumologue pour limiter les petites apnées du sommeil")
  end;
